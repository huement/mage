...
command: "/usr/local/bin/bash /Users/derekscott/Mage/dotsync/ui/.ubersicht/NetworkInfo.widget/NetworkInfo.sh"
...
update: (output, domEl) -> 
  ...
  for svc in data.service
    ...
    if svc.ipaddress == ''
      html += "  <img class='icon' src='/Users/derekscott/Mage/dotsync/ui/.ubersicht/NetworkInfo.widget/images/" + svc.name + "_disabled.png'/>"
      html += "  <p class='primaryInfo'>Not Connected</p>" 
    else
      html += "  <img class='icon' src='/Users/derekscott/Mage/dotsync/ui/.ubersicht/NetworkInfo.widget/images/" + svc.name + ".png'/>"
